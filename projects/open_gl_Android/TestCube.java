...
public class TestCube implements GLSurfaceView.Renderer
{
    ...
    private void bindData() {
        // координаты
        GLES30.glVertexAttribPointer ( 1, 3, GLES30.GL_FLOAT, false, 24, bufferShape );
        GLES30.glEnableVertexAttribArray ( 1 );

        // нормали
        bufferShape.position(3);
        GLES30.glVertexAttribPointer ( 2, 3, GLES30.GL_FLOAT, false, 24, bufferShape );
